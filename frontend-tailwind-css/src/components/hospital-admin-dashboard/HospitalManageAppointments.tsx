...
const HospitalAppointmentsManager = () => {
  ...
  const [activeTab, setActiveTab] = useState<"doctors" | "nurse">("doctors");
            ...
            {scheduleData.map((appt) => (
              ...
              >
                ...
                <p className="text-gray-700 mb-2">
                  <strong>{appt.role === 'DOCTOR' ? 'Specialization' : 'Department'}:</strong>{" "}
                  <span className="font-medium">
                    {appt.role === 'DOCTOR'
                      ? appt.assignedTo.specialization || 'N/A'
                      : appt.assignedTo.department?.name || 'N/A'}
                  </span>
                </p>
